...
namespace COMP003A.LectureActivity3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (inputNumber % 2 == 0) 
            {
                //this code executes if the condition above is true
                Console.WriteLine("\tinputNumber is even.");
            }
            else
            {
            ...
            {
                //this code block executes if the above condiiton is true
                //the rest of the conditions will no longer execute
            ...
            switch (inputNumber)
            {
                ...
                case 5:
                    //this code block executes if the case condition is true
                    Console.WriteLine("\tinpytNumber is 5.");
                    break;
                case 7:
                    //this code block executes if the case statement is true
